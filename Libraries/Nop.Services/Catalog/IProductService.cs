...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        /// The task result contains the products
        /// </returns>
        Task<IPagedList<Product>> ProductSearchAsync(
            int pageIndex = 0,
            int pageSize = int.MaxValue,
            IList<int> categoryIds = null,
            IList<int> manufacturerIds = null,
        ...
        /// <returns>
        /// A task that represents the asynchronous operation
        /// The task result contains the Binlocation
        /// </returns>
        Task<string> FormatBinlocationAsync(Product product, string attributesXml = null);
        /// <summary>
        ...
        IList<Product> GetProductsByCateId(int CateId);
