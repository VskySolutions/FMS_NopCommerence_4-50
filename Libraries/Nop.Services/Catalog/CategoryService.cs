...
namespace Nop.Services.Catalog
{
    ...
    public partial class CategoryService : ICategoryService
    {
        ...
        /// <summary>
        /// Get All Categories Instruction
        /// </summary>
        public virtual IList<Microsoft.AspNetCore.Mvc.Rendering.SelectListItem> GetAllCategoriesInstruction()
        {
            var query = from cr in _categoryRepository.Table
                        where cr.ParentCategoryId == 5
                        select cr;
            var customerRoles = query.ToList();

            List<Microsoft.AspNetCore.Mvc.Rendering.SelectListItem> AllRoles = customerRoles
