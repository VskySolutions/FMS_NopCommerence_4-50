...
namespace Nop.Services.Orders
{
    ...
    public partial class OrderService : IOrderService
    {
            ...
            string orderNotes = null, int pageIndex = 0, int pageSize = int.MaxValue, bool getOnlyTotalCount = false)
        {
            ...
            if (boIds != null && boIds.Any())
                query = query.Where(o => boIds.Contains(o.BackOrderDeliverStatus));
        ...
        /// <returns></returns>
        public virtual async Task<IPagedList<OrderItem>> SearchBackOrder(int OrderId = 0,
                                                                            int pageIndex = 0, 
                                                                            int pageSize = int.MaxValue)
        {
            var BackOrderList = await _orderItemRepository.GetAllPagedAsync(query =>
            {
