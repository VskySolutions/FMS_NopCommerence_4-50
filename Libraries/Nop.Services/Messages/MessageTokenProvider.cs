    ...
    public partial class MessageTokenProvider : IMessageTokenProvider
    {
        ...
        protected virtual async Task WriteTotalsAsync(Order order, Language language, StringBuilder sb)
        {
            ...
            else
            {
                ...
                orderSubTotalAmount = orderSubtotalExclTaxInCustomerCurrency;
                orderDiscountAmount = orderSubTotalDiscountExclTaxInCustomerCurrency;               
            ...
            //sachin code 04-10-23
            var totalWithDiscount = orderSubTotalAmount - orderDiscountAmount;
            if (totalWithDiscount <= 50)
            {
                order.IsLessSubTotal = true;
            }

            // handleing charges
            if (order.IsLessSubTotal == true)
            {
                var HandStr = "$10.00";
                sb.AppendLine($"<tr style=\"text-align:right;\"><td>&nbsp;</td><td colspan=\"2\" style=\"background-color: {_templatesSettings.Color3};padding:0.6em 0.4 em;\"><strong>{await _localizationService.GetResourceAsync("Message.Order.Handling.Charges", languageId)}</strong></td> <td style=\"background-color: {_templatesSettings.Color3};padding:0.6em 0.4 em;\"><strong>{HandStr}</strong></td></tr>");
            }
            else
            {
                var HandStr = "$00.00";
                ...
                //sb.AppendLine(string.Format("<tr style=\"text-align:right;\"><td>&nbsp;</td><td colspan=\"2\" style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{1}</strong></td> <td style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{2}</strong></td></tr>", _templatesSettings.Color3, _localizationService.GetResourceAsync("Message.Order.Handling.Charges", languageId), HandStr));
            }
