...
namespace Nop.Services.ExportImport
{
    ...
    public partial interface IExportManager
    {
        ...
        /// <param name="itemsToExport"></param>
        /// <returns></returns>
        Task<byte[]> ExportToXlsx<T>(PropertyByName<T>[] properties, IEnumerable<T> itemsToExport, string reportTitle, string createdBy, string createdFor);
