...
namespace Nop.Services.Customers
{
    ...
    public partial class CustomerRegistrationService : ICustomerRegistrationService
    {
        ...
        public virtual async Task<CustomerRegistrationResult> RegisterCustomerAsync(CustomerRegistrationRequest request)
        {
            ...
            //string CustomerRole = NopCustomerDefaults.RegisteredRoleName;
            //if (request.Customer.CustomerAccType==6)
            //{
            //    CustomerRole = "BMW Dealer";
            //}
            ...
            //add to role from Register Form- by Himali
            //await _customerService.AddCustomerRoleMappingAsync(new CustomerCustomerRoleMapping { CustomerId = request.Customer.Id, CustomerRoleId = request.Customer.CustomerAccType.Value });
