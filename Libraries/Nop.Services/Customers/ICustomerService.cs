...
namespace Nop.Services.Customers
{
    ...
    public partial interface ICustomerService
    {
        ...
        IList<Customer> GetDelearCodeExistCount(int DelearCode = 0, int Custid = 0);
        ...
        /// BMW number uplicate
        /// </summary>
        /// <param name="customer">DealerCode</param>
        /// <returns>BMW number uplicate status</returns>
        IList<Customer> GetCustomerByBMwDealerCode(int DealerCode);

        /// <summary>
        /// Send Email Async Events
        /// </summary>
        /// <param name="mail"></param>
        /// <returns></returns>
        Task SendEmailAsyncEvents(System.Net.Mail.MailMessage mail);
        ...
        List<Customer> GetCustomersForSyncingToTaxJarList(List<int> CustomerIds);

        int[] GetCustomerIdsForTaxJar(bool? IsSyncedToTaxJar, bool? IsRecentlyModified, bool? IsRecentlyDeleted, bool? IsDeleted);
        #endregion

        #region Customer SelectList
        //Added by Yogesh Kumbhar on Dt: 01-15-2025
        Task<List<SelectListItem>> GetCustomerSelectListAsync();
        #endregion

        #region Customer Secondary Email Methods
        //Added by Yogesh Kumbhar on Dt: 01-25-2025
        Task InsertCustomerEmailAsync(CustomerEmail customerEmail);
        Task<bool> ExistCustomerEmailAsync(string email, int customerId, int emailId);
        //Added by Yogesh Kumbhar on Dt: 01-25-2025
        Task<IList<CustomerEmail>> GetAllCustomerEmailByIdAsync(int customerId);
        Task DeleteCustomerEmailAsync(int customerId, int emailId);
        Task UpdateCustomerEmailAsync(CustomerEmail customerEmail);
        Task<CustomerEmail> GetCustomerEmailByIdAsync(int emailId);
        //Added by Yogesh Kumbhar on Dt: 02-05-2025
        Task<IList<string>> GetAllCustomerEmailByFlagsAsync(int customerId, bool isOrderPlaced = false, bool isOrderCancel = false, bool isEstimate = false, bool isOrderRefund = false, bool isOrderShipped = false);
        //Added by Yogesh Kumbhar on Dt: 02-11-2025
        Task<string> GetCustomerEmailWithCompanyAsync(int customerId);
        #endregion
    }
}