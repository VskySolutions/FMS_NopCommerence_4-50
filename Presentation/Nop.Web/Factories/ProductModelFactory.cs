...
namespace Nop.Web.Factories
{
    ...
    public partial class ProductModelFactory : IProductModelFactory
    {
        ...
        private readonly IEstimateService _estimateSerivce;
        ...
        public ProductModelFactory(CaptchaSettings captchaSettings,
            ...
            IEstimateService estimateSerivce,
            ...
            VendorSettings vendorSettings)
        {
            ...
            _estimateSerivce = estimateSerivce;
        }
        ...
        /// <summary>
        /// Prepare Estimate List
        /// </summary>
        /// <param name="model"></param>
        /// <param name="CustId"></param>
        /// <returns></returns>
        public virtual ProductDetailsModel PrepareEstimateList(ProductDetailsModel model, int CustId = 0)
        {
            if (CustId == 0)
                return null;

            var MyList = _estimateSerivce.GetEstimateByCustomerNumber(CustId);
            foreach (var item in MyList)
            {
                model.AvailableEstimateType.Add(new SelectListItem { Value = item.Id.ToString(), Text = item.Name });
            }
            model.AvailableEstimateType.Insert(0, new SelectListItem { Value = "0", Text = "---" });
            model.AvailableEstimateType.Insert(1, new SelectListItem { Value = "1", Text = "Add New Estimate" });
            return model;
        }
            ...
            ShoppingCartItem updatecartitem = null, bool isAssociatedProduct = false)
        {
            ...
            var model = new ProductDetailsModel
            {
                ...
                IsInstructionFile = product.IsInstructionFile,
                ProdInstructionFilePath = product.InstructionFilePath
            };
