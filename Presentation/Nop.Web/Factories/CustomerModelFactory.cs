...
namespace Nop.Web.Factories
{
    ...
    public partial class CustomerModelFactory : ICustomerModelFactory
    {
            ...
            bool excludeProperties, string overrideCustomCustomerAttributesXml = "")
        {
            ...
            model.TitleDiscription = customer.TitleDiscription;
        ...
        public virtual async Task<CustomerNavigationModel> PrepareCustomerNavigationModelAsync(int selectedTabId = 0)
        {
            ...
            model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
            {
                RouteName = "CustomerSecondaryEmails",
                Title = "Secondary Emails",
                Tab = (int)CustomerNavigationEnum.SecondaryEmails,
                ItemClass = "customer-emails"
            });
