...
namespace Nop.Web.Models.Catalog
{
    public partial record ProductDetailsModel : BaseNopEntityModel
    {
        public ProductDetailsModel()
        {
            ...
            AvailableEstimateType = new List<SelectListItem>();
        }
        ...
        public IList<SelectListItem> AvailableEstimateType { get; set; }
        public int EstimateId { get; set; }
        public bool IsInstructionFile { get; set; }
        ...
        public string ProdInstructionFilePath { get; set; }
        public bool VisibleIndividually { get; set; }
        public bool IsAuthonticate { get; set; }
