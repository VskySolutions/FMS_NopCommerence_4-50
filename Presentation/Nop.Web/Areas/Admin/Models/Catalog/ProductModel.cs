...
namespace Nop.Web.Areas.Admin.Models.Catalog
{
        ...
        IAclSupportedModel, IDiscountSupportedModel, ILocalizedModel<ProductLocalizedModel>, IStoreMappingSupportedModel
    {
        ...
        public ProductModel()
        {
            ...
            AvailableCategoriesForInstallationIn = new List<SelectListItem>();
            InstructionFileList = new InstructionFileListModel();
            ProductSearchModelList = new ProductSearchModel();
        }
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ProdCateId")]
        public int? ProdCateId { get; set; }
        public string TaxFilePath { get; set; }
        public string HideInstructionFilePath { get; set; }
        public int HideProdCate { get; set; }
        ...
        public List<SelectListItem> AvailableCategoriesForInstallationIn { get; set; }
        public bool IsInstructionFileModel { get; set; }
        public bool SelectInstallationFile { get; set; }
        public InstructionFileListModel InstructionFileList { get; set; }
        public ProductSearchModel ProductSearchModelList { get; set; }
