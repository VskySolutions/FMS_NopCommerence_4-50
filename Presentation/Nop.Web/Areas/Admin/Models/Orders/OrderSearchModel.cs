...
namespace Nop.Web.Areas.Admin.Models.Orders
{
    ...
    public partial record OrderSearchModel : BaseSearchModel
    {
        ...
        {
            AvailableBackorderStatus = new List<SelectListItem>();
            ...
            BackorderStatusIds = new List<int>();
            AvailableBackOrderStatuses = new List<SelectListItem>();
        }
        ...
        [NopResourceDisplayName("Admin.Orders.List.BackOrderStatus")]
        [UIHint("MultiSelect")]
        public List<int> BackorderStatusIds { get; set; }
        public IList<SelectListItem> AvailableOrderStatuses { get; set; }
        public IList<SelectListItem> AvailableBackorderStatus { get; set; }
        ...
        public IList<SelectListItem> AvailableBackOrderStatuses { get; set; }
