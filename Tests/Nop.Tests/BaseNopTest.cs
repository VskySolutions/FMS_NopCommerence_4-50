...
namespace Nop.Tests
{
    public partial class BaseNopTest
    {
        ...
        static BaseNopTest()
        {
            ...
            services.AddTransient<IHomePageArrivals, HomePageArrivalsService>();
            ...
            services.AddScoped<IHomePageArrivals, HomePageArrivalsService>();
            services.AddScoped<IMarquee, MarqueeService>();
            services.AddScoped<IVideoGallaryService, VideoGallaryService>();
            ...
            services.AddTransient<IVideoGalleryModelFactory, VideoGalleryModelFactory>();

            //factories
            services.AddTransient<Web.Factories.IEstimateModelFactory, Web.Factories.EstimateModelFactory>();
